...
describe('Footer', () => {
  ...
  test('renders done/total progress and formatted elapsed', () => {
    const stages: Stage[] = [
      ...
      { id: 's2', name: '', status: 'running', updatedAt: '', interactive: false, autonomous: false, autoApprove: false, hasDialog: false, showPlan: true, showDialog: false, isScript: false, pausedFrom: '' },
    ]
