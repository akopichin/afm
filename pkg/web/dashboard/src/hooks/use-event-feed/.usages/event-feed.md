...
- Watchdog: если за 75с не пришло ни события, ни heartbeat, хук сам закрывает и переоткрывает соединение — не
  нужно реализовывать проверку «зависшего» соединения на стороне потребителя.
